...
//        // Source: https://github.com/krzyzanowskim/CryptoSwift/blob/swift3-snapshots/CryptoSwiftTests/HashTests.swift
//        XCTAssertEqual(
//            try SHA256(stream).hash().hexString.lowercased(),
...
//        // Source: https://github.com/krzyzanowskim/CryptoSwift/blob/swift3-snapshots/CryptoSwiftTests/HashTests.swift
//        XCTAssertEqual(
//            try SHA384(stream).hash().hexString.lowercased(),
...
//        // Source: https://github.com/krzyzanowskim/CryptoSwift/blob/swift3-snapshots/CryptoSwiftTests/HashTests.swift
//        XCTAssertEqual(
//            try SHA512(stream).hash().hexString.lowercased(),
